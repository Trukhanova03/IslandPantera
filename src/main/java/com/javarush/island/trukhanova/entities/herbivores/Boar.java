...
public class Boar extends EatingHelper {
    public Boar(int row, int col, ISettings settings) { super(row, col, settings); }
    @Override
    public void eat(IWorld world) {
        tryToEat(world, List.of(Mouse.class, Plant.class));
    }
}
