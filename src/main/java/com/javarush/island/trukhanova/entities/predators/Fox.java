...
public class Fox extends EatingHelper {
    public Fox(int row, int col, ISettings settings) {
        super(row, col, settings);
    }

    @Override
    public void eat(IWorld world) {
        tryToEat(world, List.of(Rabbit.class, Mouse.class, Duck.class, Caterpillar.class));
    }
}
